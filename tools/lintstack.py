...
ignore_messages = ["An attribute affected in miper.tests",
...
# checked elsewhere. We also ignore miper.tests for now due to high false
# positive rate.
ignore_modules = ["miper/openstack/common/", "miper/tests/"]

# Note(thangp): E0213, E1101, and E1102 should be ignored for only
# miper.object modules. E0213 and E1102 are error codes related to
...
# the miper code base using objects. E1120 is an error code related no value
...
objects_ignore_messages = [
    ...
    "Module 'miper.objects' has no 'Snapshot' member",
    "Module 'miper.objects' has no 'SnapshotList' member",
    "Module 'miper.objects' has no 'Backup' member",
    "Module 'miper.objects' has no 'BackupList' member",
    "Module 'miper.objects' has no 'Service' member",
    "Module 'miper.objects' has no 'ServiceList' member",
    "Module 'miper.objects' has no 'BackupImport' member",
    "Module 'miper.objects' has no 'ConsistencyGroup' member",
    "Module 'miper.objects' has no 'ConsistencyGroupList' member",
]
objects_ignore_modules = ["miper/objects/"]
