...
from miper.common import config  # noqa Need to register global_opts
from miper.db import migration
from miper.db.sqlalchemy import api as sqla_api
from miper import i18n
from miper import objects
from miper import rpc
from miper import service
from miper.tests import fixtures as miper_fixtures
from miper.tests.unit import conf_fixture
from miper.tests.unit import fake_notifier
...
class TestCase(testtools.TestCase):
    ...
    def start_service(self, name, host=None, **kwargs):
        ...
        kwargs.setdefault('binary', 'miper-%s' % name)
