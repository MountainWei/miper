...
from miper.wsgi import eventlet_server as wsgi
...
class ExceptionTest(test.TestCase):
    ...
    def _do_test_exception_safety_reflected_in_faults(self, expose):
        class ExceptionWithSafety(exception.MiperException):
            safe = expose
    ...
    def test_non_miper_notfound_exception_mapping(self):
    ...
    def test_non_miper_exception_mapping(self):
        class ExceptionWithCode(Exception):
            code = 417
    ...
    @mock.patch('miper.i18n.translate')
