...
class ExecuteTestCase(test.TestCase):
    @mock.patch('miper.utils.processutils.execute')
    ...
    @mock.patch('miper.utils.get_root_helper')
    @mock.patch('miper.utils.processutils.execute')
...
class GenericUtilsTestCase(test.TestCase):
    ...
    @mock.patch('miper.utils.execute')
...
class MonkeyPatchTestCase(test.TestCase):
    ...
    def setUp(self):
        ...
        self.example_package = 'miper.tests.unit.monkey_patch_example.'
        self.flags(
            monkey_patch=True,
    ...
    def test_monkey_patch(self):
        utils.monkey_patch()
        miper.tests.unit.monkey_patch_example.CALLED_FUNCTION = []
        from miper.tests.unit.monkey_patch_example import example_a
        from miper.tests.unit.monkey_patch_example import example_b
        ...
        self.assertTrue(
            ...
            in miper.tests.unit.monkey_patch_example.CALLED_FUNCTION)
