...
from miper.api.middleware import auth
from miper.api.middleware import fault
from miper.api.openstack import wsgi as os_wsgi
from miper.api import urlmap
from miper.api import versions
...
class HTTPRequest(webob.Request):
    ...
    def blank(cls, *args, **kwargs):
        ...
        out.environ['miper.context'] = FakeRequestContext(
            'fake_user',
            'fakeproject',
