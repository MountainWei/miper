...
from miper.api.views import versions as views_versions
        ...
        "media-types": [
            {
                ...
                "type": "application/vnd.openstack.miper+xml;version=1",
            },
            {
                "base": "application/json",
                "type": "application/vnd.openstack.miper+json;version=1",
            }
        ],
    }
}
...
def create_resource():
    return wsgi.Resource(MiperVersion())
