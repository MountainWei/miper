...
api_common_opts = [
    ...
    cfg.StrOpt('osapi_miper_base_URL',
               default=None,
               help='Base URL that will be presented to users in links '
                    'to the OpenStack Miper API',
...
def remove_version_from_href(href):
    ...
    Given: 'http://www.miper.com/v1.1/123'
    Returns: 'http://www.miper.com/123'

    Given: 'http://www.miper.com/v1.1'
    Returns: 'http://www.miper.com'
...
class ViewBuilder(object):
    ...
    def _get_next_link(self, request, identifier, collection_name):
        ...
        prefix = self._update_link_prefix(get_request_url(request),
                                          CONF.osapi_miper_base_URL)
        url = os.path.join(prefix,
                           request.environ["miper.context"].project_id,
                           collection_name)
