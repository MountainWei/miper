...
from miper.wsgi import common as wsgi


XML_NS_V1 = 'https://www.openstack.org/mediawiki/Miper/1.0/content'
...
SUPPORTED_CONTENT_TYPES = (
    'application/json',
    'application/vnd.openstack.miper+json',
    'application/xml',
    'application/vnd.openstack.miper+xml',
)

_MEDIA_TYPE_MAP = {
    'application/vnd.openstack.miper+json': 'json',
    'application/json': 'json',
    'application/vnd.openstack.miper+xml': 'xml',
    'application/xml': 'xml',
...
class Request(webob.Request):
    ...
    def best_match_content_type(self):
        ...
        if 'miper.best_content_type' not in self.environ:
            ...
            self.environ['miper.best_content_type'] = (content_type or
                                                      'application/json')

        return self.environ['miper.best_content_type']
...
class Resource(wsgi.Application):
    ...
    def register_actions(self, controller):
        """Rmiperters controller actions with this resource."""
    ...
    def register_extensions(self, controller):
        """Rmiperters controller extensions with this resource."""
    ...
    def _process_stack(self, request, action, action_args,
        ...
        context = request.environ.get('miper.context')
...
def _set_request_id_header(req, headers):
    context = req.environ.get('miper.context')
    if context:
