...
import miper.api.openstack
from miper.api.openstack import wsgi
from miper.api import xmlutil
from miper import exception
from miper.i18n import _LE, _LI, _LW
import miper.policy
...
class ExtensionDescriptor(object):
    ...
    def __init__(self, ext_mgr):
        """Rmiperter extension with the extension manager."""
...
class ExtensionManager(object):
    ...
    See miper/tests/api/extensions/foxinsocks/extension.py for an
    ...
    def __init__(self):
        ...
        self.cls_list = CONF.osapi_miper_extension
        self.extensions = {}
...
class ControllerExtension(object):
    """Extend core controllers of miper OpenStack API.

    Provide a way to extend existing miper OpenStack API core
    controllers.
    """
...
class ResourceExtension(object):
    """Add top level resources to the OpenStack API in miper."""
...
def load_standard_extensions(ext_mgr, logger, path, package, ext_list=None):
    """Rmiperters all standard API extensions."""
...
def extension_authorizer(api_name, extension_name):
    def authorize(context, target=None, action=None):
        ...
        miper.policy.enforce(context, act, target)
    return authorize
