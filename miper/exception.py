# Copyright 2014 Beijing Huron Technology Co.Ltd.
#
...
"""Miper base exception handling.

Includes decorator for re-raising Miper-type exceptions.
...
class NotAuthorized(MiperException):
...
class MalformedRequestBody(MiperException):
...
class NoValidHost(MiperException):
    message = _("No valid host was found. %(reason)s")


class NoMoreTargets(MiperException):
    """No more available targets."""
    pass


class KeyManagerError(MiperException):
